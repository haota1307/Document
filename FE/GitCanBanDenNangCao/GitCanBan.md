...
```bash
git config --global user.name "Tran Anh Hao"
git config --global user.email trananhhao@gmail.com
```
...
```bash
Your identification has been saved in /c/Users/dutha/.ssh/id_trananhhao10
Your public key has been saved in /c/Users/dutha/.ssh/id_trananhhao10.pub
```

Để đọc nội dung public SSH key thì bạn chỉ có khá nhiều cách, bạn dùng cách nào dưới đây cũng được. Ví dụ file public key của mình bên trên là `id_trananhhao10.pub`

- Copy đường dẫn này `c:/Users/dutha/.ssh/id_trananhhao10.pub` bỏ lên Chrome thì nó sẽ ra nội dung của public key
- Dùng git bash gõ `cat /c/Users/dutha/.ssh/id_trananhhao10.pub`
...
#React-Awesome trananhhao06
Host github-trananhhao06.com
HostName github.com
User git
IdentityFile ~/.ssh/id_rsa_trananhhao06
```

Ở trên thì mình có dùng 2 tài khoản Github, cái đầu tiên dùng với private key là `id_rsa` với Host là `github.com`, cái thứ hai là `id_rsa_trananhhao06` với Host là `github-trananhhao06.com`.
...
```bash
git clone git@github-trananhhao06.com:dreact04072022/git-can-ban.git
```

Tương tự với những câu lệnh như `git remote add origin git@github-trananhhao06.com:dreact04072022/git-can-ban.git`
